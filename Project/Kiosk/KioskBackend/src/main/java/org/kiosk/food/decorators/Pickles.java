...
public class Pickles extends IngridientDecorator {
    private static String ingredientName;
    private static int ingredientPrice;
    private static ArrayList<FoodType> foodTypes;
    public Pickles(IFood food) throws ClassNotFoundException {
        super(food);
        initialize();
    }

    private static void initialize() throws ClassNotFoundException {
        ingredientName = (Class.forName("org.kiosk.food.decorators.Pickles")).getName().split("\\.")[4];
        ingredientPrice = 80;
