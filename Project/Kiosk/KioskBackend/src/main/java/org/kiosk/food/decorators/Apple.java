...
public class Apple extends IngridientDecorator {
    private static String ingredientName;
    private static int ingredientPrice;
    private static ArrayList<FoodType> foodTypes;
    public Apple(IFood food) throws ClassNotFoundException {
        super(food);
        initialize();
    }

    private static void initialize() throws ClassNotFoundException {
        ingredientName = (Class.forName("org.kiosk.food.decorators.Apple")).getName().split("\\.")[4];
        ingredientPrice = 300;
